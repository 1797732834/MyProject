...
import com.beicai.da.leida_test.R;
...
public class MyAdapter extends BaseAdapter{
  ...
  public MyAdapter(Context c, News news, ArrayList<HashMap<String,Object>> arrayList){
...
//    if(view == null){
    view = View.inflate(c,R.layout.zhu_sty,null);
    holder = new ViewHolder();
    holder.imageView1 = view.findViewById(R.id.sty_image1);
    holder.imageView2 = view.findViewById(R.id.sty_image2);
    holder.imageView3 = view.findViewById(R.id.sty_image3);
    holder.txTitle = view.findViewById(R.id.sty_text);
    //根据集合的变化刷新UI
